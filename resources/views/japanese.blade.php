<article class="message is-dark">
    ...
    <div class="message-body content">
        ...
        <p>
            CloudFrontから完全に静的に配信してるので動的な機能はDiscord botを経由して行う。#packagistチャンネルでのみ有効。
        </p>
        ...
        <h3>設定</h3>
        <ul>
            <li>現在の設定は15分ごとの更新。急ぐならDiscordで操作する想定。</li>
        </ul>
        ...
        <ul>
            ...
            <li>S3への同期が一番時間のかかる重い処理になっていたのでS3+CloudFront構成は終了。CloudFrontだけ使用。</li>
        </ul>
    </div>
</article>
